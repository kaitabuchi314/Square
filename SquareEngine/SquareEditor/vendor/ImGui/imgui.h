...
namespace ImGui
{
    ...
    // - When io.Config
    // ingWithShift == true, you instead need to hold SHIFT to enable docking.
    // About dockspaces:
...
namespace ImGui
{
    ...
    */
	bool ImageButtonText(ImTextureID tex, int width, int height, int offX, int offY, const char* text);
}
